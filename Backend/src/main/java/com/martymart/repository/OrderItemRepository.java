...
public interface OrderItemRepository extends JpaRepository<OrderItem, String> {
    ...
    @Query(value = "INSERT INTO order_item VALUES (:#{#order_item.order_item_id}, :#{#order_item.order_id}, :#{#order_item.product_id}, :#{#order_item.quantity}, :#{#order_item.price})", nativeQuery = true)
