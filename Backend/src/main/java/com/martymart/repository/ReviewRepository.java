...
public interface ReviewRepository extends JpaRepository<Review, String> {
    ...
    @Modifying
    @Query(value = "INSERT INTO review (review_id, product_id, customer_id, rating, review, review_date, review_time) VALUES (:#{#review.review_id}, :#{#review.product_id}, :#{#review.customer_id}, :#{#review.rating}, :#{#review.review}, :#{#review.review_date}, :#{#review.review_time})", nativeQuery = true)
