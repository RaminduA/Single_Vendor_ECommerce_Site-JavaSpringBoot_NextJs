...
public interface OrderRepository extends JpaRepository<Order, String> {
    ...
    @Modifying
    @Query(value = "INSERT INTO orders (order_id, customer_id, order_date, order_time, total_price) VALUES (:#{#order.order_id}, :#{#order.customer_id}, :#{#order.order_date}, :#{#order.order_time}, :#{#order.total_price})", nativeQuery = true)
